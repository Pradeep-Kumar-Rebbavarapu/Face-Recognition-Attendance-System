...
export default function DateCard({ele}) {
    return (
        <Link href={`/CoursesPage/${ele.course}/${ele.dates}`} className='flex justify-center items-center py-10'>
            <div className="card work">
                ...
                <div className="card-desc">
                    <div className="card-header">
                        <div className="card-title">{ele.dates}</div>
                    ...
                    <div className="card-time">{ele.course}</div>
