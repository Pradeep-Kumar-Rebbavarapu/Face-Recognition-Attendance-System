...
export default function Navbar() {
  ...
  return (
    <header className="text-gray-900 body-font bg-white fixed z-[100000] w-full ">
      <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        ...
        <nav className="md:ml-auto flex flex-wrap items-center text-base justify-center">
          ...
          <Link href="/Attendance" className="mr-5 hover:text-black hover:font-bold font-semibold hover:scale-105 transition-all fade-in-out ">Attendance</Link>
